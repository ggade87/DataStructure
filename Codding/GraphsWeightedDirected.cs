...
namespace Codding
{
    class GraphsWeightedDirected
    {
        int vertices;
        int[,] adjMat;

        public GraphsWeightedDirected(int n)
        {
            vertices = n;
            adjMat = new int[n, n];
        }
        ...
        {
            GraphsWeightedDirected g = new GraphsWeightedDirected(4);
            ...
            Console.WriteLine("Edge between 2--1: " + g.existEdge(2, 1));
